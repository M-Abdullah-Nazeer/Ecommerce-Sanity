import { formatCuurency } from "@/lib/formatCurrency";
                                    ...
                                    <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                                        ...
                                        <div className="sm:text-right">
                                            ...
                                            <p className="font-bold text-lg">
                                                ...
                                                {formatCuurency(order.totalPrice ?? 0, order.currency)}
                                    ...
                                    {order.amountDiscount ? (
                                        ...
                                        <div className="mt-4 p-3 sm:p-4 bg-red-50 rounded-lg">
                                            ...
                                            <p className="text-red-600 font-medium mb-1 text-sm sm:text-base">
                                                Discount Applied:{" "}
                                                {formatCuurency(order.amountDiscount, order.currency)}
                                            </p>
                                            <p className="text-sm text-gray-600">

                                                Original Subtotal:{" "}
                                                {formatCuurency((order.totalPrice ?? 0) + order.amountDiscount, order.currency)}
